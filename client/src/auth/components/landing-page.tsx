  ...
  return (
    <Box bg="dark.9" c="gray.3" mih="100vh">
            ...
            <Group gap="xs">
              <Center
                ...
                style={{
                  borderRadius: 8,
                  boxShadow:
                    "0 4px 12px color-mix(in srgb, var(--mantine-color-blue-5) 20%, transparent)",
                }}
              >
              ...
              <Text fw={700} size="xl" c="white" lts="-0.02em">
                Class
                <Text fw="inherit" component="span" c="blue.4">
                  Dir
                </Text>
              </Text>
            </Group>
      ...
      <Box component="section" pos="relative" pt={128} pb={96} style={{ overflow: "hidden" }}>
        ...
        <Container size="lg">
          <Stack align="center" gap="lg" ta="center">
            ...
            >
              <Box w={6} h={6} bg="teal.4" className={classes.dot} />
              No sign-up required
            </Group>
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(to right, var(--mantine-color-blue-4), var(--mantine-color-blue-5))",
            ...
            <Text size="lg" c="dimmed" maw={560} lh={1.6}>
              Create beautiful lesson slides and guide your students through them in real time —
              from any device, no accounts needed.
            </Text>
            ...
            <Group mt="md" gap="md" justify="center">
              <Button
                ...
                style={{
                  boxShadow:
                    "0 4px 16px color-mix(in srgb, var(--mantine-color-blue-6) 20%, transparent)",
                }}
              >
                Get Started
              </Button>
        ...
        <Container size="lg">
          <Stack align="center" gap="xs" mb={64}>
            ...
            <Text c="dimmed" maw={480} ta="center">
              ClassDir helps you prepare and deliver your classes without fighting with complicated
              tools.
            </Text>
          </Stack>
      ...
      <Box
        component="footer"
        py="lg"
        style={{ borderTop: "1px solid var(--mantine-color-dark-8)" }}
      >
        <Container size="lg">
          <Group justify="space-between" fz={13} c="gray.6">
            ...
            <Text c="dimmed">
              {new Date().getFullYear()} ClassDir. Built for digital education.
            </Text>
          </Group>
        </Container>
      </Box>
