import { z } from "zod";
import {
  WS_EVENT_SLIDE_CHANGED,
  WS_EVENT_ANNOTATION_ADDED,
  WS_EVENT_ANNOTATIONS_BATCH,
  WS_ANNOTATION_TYPE_CLEAR,
  WS_ANNOTATION_TYPE_STROKE,
} from "./cfg";
...
export const WSOutputMessageSchema = z
  .object({
